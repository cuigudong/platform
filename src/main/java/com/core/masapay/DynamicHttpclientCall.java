...
//
//	private static final Logger logger = LoggerFactory.getLogger(DynamicHttpclientCall.class);
//	public static final String URL = "http://open-sandbox.masapay.com/masapi/refund/RefundMerchantOrder?wsdl";
//
...
//
//		// DynamicHttpclientCall dynamicHttpclientCall = new
//		// DynamicHttpclientCall("refundMerchantOrder",
...
//		// map.put("signMsg", getSHA256Str(signText));
...
//		String refund = JacksonUtil.writeValueAsString(resultMap);
//		RefundResDTO resp = JacksonUtil.readValue(refund, RefundResDTO.class);
//		if (resp != null) {
//			System.out.println(String.format("masapay refund-resp bis: %s", resp.toString()));
//			String respSignText = resp.signatureData("123456");
//			System.out.println(String.format("masapay refund-resp bis-respSignText: %s", respSignText));
//			String respSignMsg = getSHA256Str(respSignText);
//			System.out.println(String.format("masapay refund-resp bis-respSignMsg: %s", respSignMsg));
//			if (resp.getSignMsg().equalsIgnoreCase(respSignMsg)) {
//				System.out.println("11-"+resp);
//			} else {
